...
function dataViz(incomingData) {
    ...
    g.selectAll(".bar")
        ...
        .attr("height", function (d) {
            return h - yScale(d.var1);
        });

    d3.select(".hist2").on("click", function () {
        incomingData.forEach(function (d) {
            d.var2 = +d.var2;
        });
        yScale.domain([0, d3.max(incomingData, function (d) {
...
/*d3.csv("assets/data/data.csv").then(function(data){
    ...
    yScale.domain([0,d3.max(data,function(d){return d.var1;})]);
    ...
    g.selectAll(".bar")
            ...
            .attr("height",function(d){return h - yScale(d.var1);});
});*/